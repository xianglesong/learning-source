...
/**
 * Shuts down a list of {@link Executor}s. {@link #terminate(Executor...)} will shut down all
 * specified {@link ExecutorService}s immediately and wait for their termination. An
 * {@link Executor} which is not an {@link ExecutorService} will be ignored silently.
 *
...
public class ExecutorUtil {
  ...
  /**
   * Returns {@code true} if and only if the specified {@code executor} is an
   * {@link ExecutorService} and is shut down. Please note that this method returns {@code false} if
   * the specified {@code executor} is not an {@link ExecutorService}.
   */
