 ...
 * <p>
 * This interface was introduced to initialize the {@link ChannelPipeline} of the child channel
 * accepted by a {@link ServerChannel}, but it is safe to use it for any other purposes.
 *
