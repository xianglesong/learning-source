 ...
 * <p>
 * A {@link ChannelSink} is an internal component which is supposed to be implemented by a transport
 * provider. Most users will not see this type in their code.
 *
 * @author The Netty Project (netty-dev@lists.jboss.org)
 * @author Trustin Lee (tlee@redhat.com)
 *
 * @version $Rev: 186 $, $Date: 2008-09-02 22:20:03 +0900 (Tue, 02 Sep 2008) $
 *
...
public interface ChannelSink {
  ...
  /**
   * Invoked by {@link ChannelPipeline} when a downstream {@link ChannelEvent} has reached its
   * terminal (the head of the pipeline).
   */
  void eventSunk(ChannelPipeline pipeline, ChannelEvent e) throws Exception;

  /**
   * Invoked by {@link ChannelPipeline} when an exception was raised while one of its
   * {@link ChannelHandler}s process a {@link ChannelEvent}.
   */
