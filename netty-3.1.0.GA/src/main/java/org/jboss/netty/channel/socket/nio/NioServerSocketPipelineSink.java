...
class NioServerSocketPipelineSink extends AbstractChannelSink {
  ...
  static final InternalLogger logger = InternalLoggerFactory
      .getInstance(NioServerSocketPipelineSink.class);
  ...
  private void bind(NioServerSocketChannel channel, ChannelFuture future, SocketAddress localAddress) {
    ...
    try {
      ...
      bossExecutor.execute(new IoWorkerRunnable(new ThreadRenamingRunnable(new Boss(channel),
  ...
  private final class Boss implements Runnable {
    ...
    private void registerAcceptedChannel(SocketChannel acceptedSocket, Thread currentThread) {
      try {
        ...
        worker.register(new NioAcceptedSocketChannel(channel.getFactory(), pipeline, channel,
